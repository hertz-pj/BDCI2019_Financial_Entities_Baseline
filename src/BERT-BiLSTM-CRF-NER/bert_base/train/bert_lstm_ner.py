...
def train(args):
    ...
    if args.do_predict:
        token_path = os.path.join(args.output_dir, "token_test_final.txt")
        ...
        predict_file = os.path.join(args.output_dir, "predict_final.tf_record")
        ...
        output_predict_file = os.path.join(args.output_dir, "label_test_final_repro.txt")
        ...
        # 写结果到文件中
        with codecs.open(os.path.join(args.output_dir, 'predict_score_final.txt'), 'a', encoding='utf-8') as fd:
