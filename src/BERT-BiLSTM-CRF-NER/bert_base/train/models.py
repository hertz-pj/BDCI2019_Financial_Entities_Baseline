...
from bert_base.train.utils import transition_mask
from bert_base.train.utils import get_wordshape
...
def create_model(bert_config, is_training, input_ids, input_mask,
    ...
    SPAN_TYPE = "IOB2"
    mask = transition_mask(label_vocab, SPAN_TYPE, label_vocab["[CLS]"], label_vocab["[SEP]"])
